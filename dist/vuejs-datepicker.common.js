...
var script$1 = {
  ...
  methods: {
     ...
     * @return {Boolean}
     */
    isAdditionalHighlightedDate: function isAdditionalHighlightedDate(date) {
      var _this3 = this;
      ...
      if (typeof this.highlighted.additional !== 'undefined') {
        this.highlighted.additional.forEach(function (d) {
